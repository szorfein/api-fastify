...
module.exports = fp(async function shemaLoaderUserPlugin(fastify, _opts) {
    ...
    fastify.addSchema(require('./create-user.json'));
    fastify.addSchema(require('./create-user-response.json'));
